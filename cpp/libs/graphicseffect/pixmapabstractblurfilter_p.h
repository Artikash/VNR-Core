#ifndef _GRAPHICSEFFECT_PIXMAPABSTRACTBLURFILTER_P_H
#define _GRAPHICSEFFECT_PIXMAPABSTRACTBLURFILTER_P_H
...
#endif // _GRAPHICSEFFECT_PIXMAPABSTRACTBLURFILTER_P_H
