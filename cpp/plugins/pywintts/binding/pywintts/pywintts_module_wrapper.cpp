...
void cleanTypesAttributes(void) {
    for (int i = 0, imax = SBK_pywintts_IDX_COUNT; i < imax; i++) {
        PyObject *pyType = reinterpret_cast<PyObject*>(SbkpywinttsTypes[i]);
...
SBK_MODULE_INIT_FUNCTION_BEGIN(pywintts)
    ...
    SbkpywinttsTypeConverters[SBK_PYWINTTS_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpywinttsTypeConverters[SBK_PYWINTTS_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpywinttsTypeConverters[SBK_PYWINTTS_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    SbkpywinttsTypeConverters[SBK_PYWINTTS_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(SbkpywinttsTypeConverters[SBK_PYWINTTS_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpywinttsTypeConverters[SBK_PYWINTTS_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    SbkpywinttsTypeConverters[SBK_PYWINTTS_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpywinttsTypeConverters[SBK_PYWINTTS_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpywinttsTypeConverters[SBK_PYWINTTS_QMAP_QSTRING_QVARIANT_IDX],
