...
enum Type {
  Type1    // Old System4Engine2, self in ecx
  , Type2  // New System4Engine2, self in arg1, since リア充クラスメイト孕ませ催眠 in 9/26/2014
};
int type_; // static
 ...
 */
ulong System4Engine::search(ulong startAddress, ulong stopAddress, int *type)
{
  ulong addr;
