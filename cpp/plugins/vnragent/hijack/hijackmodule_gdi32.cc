...
#define DEBUG "hijackmodule_gdi32"
...
BOOL WINAPI Hijack::newExtTextOutA(HDC hdc, int X, int Y, UINT fuOptions, const RECT *lprc, LPCSTR lpString, UINT cbCount, const INT *lpDx)
{
#ifdef HIJACK_GDI_TEXT
  DOUT("pass");
...
int WINAPI Hijack::newDrawTextA(HDC hDC, LPCSTR lpchText, int nCount, LPRECT lpRect, UINT uFormat)
{
#ifdef HIJACK_GDI_TEXT
  DOUT("pass");
#endif // HIJACK_GDI_TEXT
...
int WINAPI Hijack::newDrawTextExA(HDC hdc, LPSTR lpchText, int cchText, LPRECT lprc, UINT dwDTFormat, LPDRAWTEXTPARAMS lpDTParams)
{
#ifdef HIJACK_GDI_TEXT
  DOUT("pass");
#endif // HIJACK_GDI_TEXT
