...
__all__ = (
  ...
  'TransformScriptWriter', 'InputScriptWriter', 'OutputScriptWriter',
  'CodecScriptWriter', 'EncodeScriptWriter', 'DecodeScriptWriter',
)
...
if skos.WIN:
  ...
  from pytrcodec import TranslationCodec

class AbstractScriptWriter(object):
  def __init__(self, query, type, fr, to):
    self.query = query # ScriptQuery
    self.type = type # str
    self.fr = fr # str
    self.to = to # str

  def isOutdated(self): return False # reserved to be written

class TransformScriptWriter(object):

  def __init__(self, createTime, query):
