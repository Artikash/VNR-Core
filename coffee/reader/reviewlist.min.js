...
scores:a.scores})};u=function(a){return $(".topic[data-id="+a+"]")};q=function(a){return _.findWhere(f,{id:a})};x=function(a){return topicEditBean.editTopic(JSON.stringify(a))};t=function(a){return topicInputBean.replyTopic(a)};l=function(){return $(".topic.topic-new").each(function(){var a,b,c,d,f;c=$(this).removeClass("topic-new");f=c.data("id");d=q(f);b=c.find("> .right > .header");a=c.find("> .right > .footer");b.find("a.user").click(function(){null!=d&&d.userName&&mainBean.showUser(d.userName);
return!1});a.find(".btn-edit").click(function(){d&&x(d);return!1});a.find(".btn-reply").click(function(){t(d);return!1});b.find(".title").click(function(){t(d);return!1});(null!=d&&d.likeCount||null!=d&&d.dislikeCount)&&a.find(".like-group").removeClass("fade-in");a.find(".btn.like").click(function(){var b,k,g,c;d&&USER_NAME&&USER_NAME!==d.userName&&(b=a.find(".btn.dislike.selected"),b.length&&(b.removeClass("selected"),g=b.find(".value"),g.text(-1+Number(g.text()))),k=$(this),k.parent(".like-group").removeClass("fade-in"),
c=k.hasClass("selected"),ticket.update({data:{login:USER_NAME,password:USER_PASSWORD,targetType:"topic",targetId:f,type:"like",value:c?0:1},success:function(a){return function(){k.toggleClass("selected");g=k.find(".value");return g.text((c?-1:1)+Number(g.text()))}}(this)}));return!1});return a.find(".btn.dislike").click(function(){var b,c,g,e;d&&USER_NAME&&USER_NAME!==d.userName&&(b=a.find(".btn.like.selected"),b.length&&(b.removeClass("selected"),g=b.find(".value"),g.text(-1+Number(g.text()))),c=
$(this),c.parent(".like-group").removeClass("fade-in"),e=c.hasClass("selected"),ticket.update({data:{login:USER_NAME,password:USER_PASSWORD,targetType:"topic",targetId:f,type:"like",value:e?0:-1},success:function(a){return function(){c.toggleClass("selected");g=c.find(".value");return g.text((e?-1:1)+Number(g.text()))}}(this)}));return!1})})};p=function(a){var b;f.push.apply(f,a);document.title=""+n+" ("+f.length+")";var c,d,e;e=[];c=0;for(d=a.length;c<d;c++)b=a[c],"review"===b.type&&e.push(m(b));
a=e.join("");$(".topics").append(a);return l()};r=function(){return $(".topic.topic-new").effect("highlight",1500)};e=function(a){return $("#spin").spin(a?"large":!1)};z=function(){e(!0);return rest.forum.list("topic",{data:{subjectId:GAME_ID,subjectType:"game",type:"review",sort:"updateTime",asc:!1,limit:20,complete:!0},error:function(){e(!1);return growl.warn(tr("Internet error"))},success:function(a){e(!1);return a.length?p(a):growl.warn(tr("Internet error"))}})};y=function(){e(!0);return rest.forum.list("topic",
{data:{subjectId:GAME_ID,subjectType:"game",sort:"updateTime",asc:!1,complete:!0,first:f.length,limit:20},error:function(){e(!1);return growl.warn(tr("Internet error"))},success:function(a){e(!1);return a.length?p(a):growl(tr("No more"))}})};v=function(){return $(".topic > .footer > .btn-more").click(function(){var a;a=$(this);a.data("locked")||(a.data("lock",!0),y(),a.data("lock",!1));return!1})};this.READY=!1;this.addTopic=function(a){f.push(a);document.title=""+n+" ("+f.length+")";return"review"===
a.type?(a=m(a),$(a).prependTo(".topics"),r(),l()):h("addTopic: error: unknown topic type")};this.updateTopic=function(a){var b;if(b=q(a.id))if(util.fillObject(b,a),b=u(a.id),b.length){a=$(m(a));b.replaceWith(a);r();l();return}return h("updateTopic: error: topic lost")};s=function(){if(null==this.i18nBean)return h("init: wait"),setTimeout(s,100);h("init: enter");moment.locale("ja");w();v();z();this.READY=!0;return h("init: leave")};$(function(){return s()})}).call(this);
