...
b.$more;this.$topic=b.$topic;this.topicId=b.topicId;this.search=b.search;this.more=c(this.more,this);this.show=c(this.show,this);this.refresh=c(this.refresh,this);this.bind=c(this.bind,this);this.updatePost=c(this.updatePost,this);this.addPost=c(this.addPost,this);this._highlightNewPosts=c(this._highlightNewPosts,this);this.addPosts=c(this.addPosts,this);this._bindNewPosts=c(this._bindNewPosts,this);this.getPost=c(this.getPost,this);this.$getPost=c(this.$getPost,this);this.$sel=this.$postContainer;
null!=this.$topicContainer&&(this.$sel=this.$sel.add(this.$topicContainer));this.posts=[];this.bind()}a.prototype.$getPost=function(b){return this.$sel.find(".post[data-id="+b+"]")};a.prototype.getPost=function(b){return _.findWhere(this.posts,{id:b})};a.prototype._bindNewPosts=function(){var b;b=this;return this.$sel.find(".post.post-new").each(function(){var d,a,f,e,c;f=$(this).removeClass("post-new");c=f.data("id");e=b.getPost(c);a=f.find("> .right > .header");d=f.find("> .right > .footer");a.find("a.user").click(function(){null!=
