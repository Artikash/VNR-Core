...
tr("Add")+'") '+tr("Add")+'\n    :if image\n      .image\n        %a(href="${image.url}" title="${image.title}")\n          %img(src="${image.url}" alt="${image.title}")').replace(/\$/g,"#"))};r=function(a){var d,b,c;d=b=null;a.createTime&&(d=moment(1E3*a.createTime));a.updateTime>a.createTime&&(b=moment(1E3*a.updateTime));return k({id:a.id,type:a.type,typeName:util.getTopicTypeName(a.type),editable:a.userName===USER_NAME&&(c=a.type,0<=s.call(util.TOPIC_TYPES,c)),lang:util.getLangName(a.lang),subjectId:a.subjectId,
...
d)};q=function(a){return topicEditBean.editTopic(JSON.stringify(a))};this.topicjs={init:function(){return n()},Topic:function(){function a(a,b){this.id=a;this.$sel=b.$container;this.show=g(this.show,this);this.updateTopic=g(this.updateTopic,this);this.showTopic=g(this.showTopic,this);this._highlightTopic=g(this._highlightTopic,this);this._bindTopic=g(this._bindTopic,this);this.topic={}}a.prototype._bindTopic=function(){var a,b,c,m,e,g;c=this.$sel.children(".topic");e=this.topic;g=c.data("id");m=c.data("subject-id");
b=c.find("> .right > .header");a=c.find("> .right > .footer");c.find("a.link-game").click(function(){m&&mainBean.showGame(m);return!1});b.find("a.user").click(function(){null!=e&&e.userName&&mainBean.showUser(e.userName);return!1});a.find(".btn-edit").click(function(){q(e);return!1});a.find(".btn-add").click(function(){l(g,"topic");return!1});a.find(".btn-reply").click(function(){l(g,"post");return!1});(null!=e&&e.likeCount||null!=e&&e.dislikeCount)&&a.find(".like-group").removeClass("fade-in");a.find(".btn.like").click(function(){var b,
c,f,h;e&&USER_NAME&&USER_NAME!==e.userName&&(b=a.find(".btn.dislike.selected"),b.length&&(b.removeClass("selected"),f=b.find(".value"),f.text(-1+Number(f.text()))),c=$(this),c.parent(".like-group").removeClass("fade-in"),h=c.hasClass("selected"),ticket.update({data:{login:USER_NAME,password:USER_PASSWORD,targetType:"topic",targetId:g,type:"like",value:h?0:1},success:function(a){return function(){c.toggleClass("selected");f=c.find(".value");return f.text((h?-1:1)+Number(f.text()))}}(this)}));return!1});
return a.find(".btn.dislike").click(function(){var b,c,f,h;e&&USER_NAME&&USER_NAME!==e.userName&&(b=a.find(".btn.like.selected"),b.length&&(b.removeClass("selected"),f=b.find(".value"),f.text(-1+Number(f.text()))),c=$(this),c.parent(".like-group").removeClass("fade-in"),h=c.hasClass("selected"),ticket.update({data:{login:USER_NAME,password:USER_PASSWORD,targetType:"topic",targetId:g,type:"like",value:h?0:-1},success:function(a){return function(){c.toggleClass("selected");f=c.find(".value");return f.text((h?
-1:1)+Number(f.text()))}}(this)}));return!1})};a.prototype._highlightTopic=function(){return this.$sel.effect("highlight",1500)};a.prototype.showTopic=function(a){this.topic=a;return this.updateTopic(this.topic,!1)};a.prototype.updateTopic=function(a,b){var c;null==b&&(b=!0);if(a.id!==this.topic.id)p("different topic id");else return this.topic=a,c=r(this.topic),this.$sel.html(c),b&&this._highlightTopic(),this._bindTopic()};a.prototype.show=function(a){var b,c;c=a.success;b=this;spin(!0);return rest.forum.query("topic",
{data:{id:this.id},error:function(){spin(!1);return growl.warn(tr("Internet error"))},success:function(a){spin(!1);if(a.id)return b.showTopic(a),"function"===typeof c?c():void 0}})};return a}()}}).call(this);
