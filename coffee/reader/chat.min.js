...
return a.length?t(a):growl(tr("No more"))}})};w=function(){return $(".topic > .footer > .btn-more").click(function(){var a;a=$(this);a.data("locked")||(a.data("lock",!0),z(),a.data("lock",!1));return!1})};this.READY=!1;this.addPost=function(a){var b;k.push(a);document.title=""+s+" ("+k.length+")";return"post"===a.type?(a=n(a),$(a).prependTo(".topic > .posts"),r(),p()):"reply"===a.type?(b=q(a.replyId),b.length?(a=n(a),$(a).appendTo(b.children(".reply")),r(),p()):l("addPost: error: post lost")):l("addPost: error: unknown post type")};
