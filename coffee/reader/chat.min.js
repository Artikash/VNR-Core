...
a=h.find("> .right > .footer");b.find("a.user").click(function(){null!=c&&c.userName&&mainBean.showUser(c.userName);return!1});a.find(".btn-edit").click(function(){c&&y(c);return!1});a.find(".btn-reply").click(function(){B(g);return!1});(null!=c&&c.likeCount||null!=c&&c.dislikeCount)&&a.find(".like-group").removeClass("fade-in");a.find(".btn.like").click(function(){var b,e,f,m;c&&c.userName!==USER_NAME&&(b=a.find(".btn.dislike.selected"),b.length&&(b.removeClass("selected"),f=b.find(".value"),f.text(-1+
Number(f.text()))),e=$(this),e.parent(".like-group").removeClass("fade-in"),m=e.hasClass("selected"),ticket.update({data:{login:USER_NAME,password:USER_PASSWORD,targetType:"post",targetId:g,type:"like",value:m?0:1},success:function(a){return function(){e.toggleClass("selected");f=e.find(".value");return f.text((m?-1:1)+Number(f.text()))}}(this)}));return!1});return a.find(".btn.dislike").click(function(){var b,e,f,m;c&&c.userName!==USER_NAME&&(b=a.find(".btn.like.selected"),b.length&&(b.removeClass("selected"),
f=b.find(".value"),f.text(-1+Number(f.text()))),e=$(this),e.parent(".like-group").removeClass("fade-in"),m=e.hasClass("selected"),ticket.update({data:{login:USER_NAME,password:USER_PASSWORD,targetType:"post",targetId:g,type:"like",value:m?0:-1},success:function(a){return function(){e.toggleClass("selected");f=e.find(".value");return f.text((m?-1:1)+Number(f.text()))}}(this)}));return!1})})};t=function(a){var b,h,c,g,d,e;k.push.apply(k,a);document.title=""+s+" ("+k.length+")";h=function(){var b,e,
d;d=[];b=0;for(e=a.length;b<e;b++)c=a[b],"post"===c.type&&d.push(n(c));return d}().join("");$(".topic > .posts").append(h);g=function(){var b,e,d;d=[];b=0;for(e=a.length;b<e;b++)c=a[b],"reply"===c.type&&d.push(c);return d}();if(g.length)for(g=_.sortBy(g,function(a){return a.createTime}),d=0,e=g.length;d<e;d++)c=g[d],b=q(c.replyId),b.length?(h=n(c),b.children(".reply").append(h)):l("addPosts: error: post lost");return p()};r=function(){return $(".post.post-new").effect("highlight",1500)};d=function(a){return $("#spin").spin(a?
"large":!1)};A=function(){d(!0);return rest.forum.list("post",{data:{topic:TOPIC_ID,sort:"updateTime",asc:!1,limit:20},error:function(){d(!1);return growl.warn(tr("Internet error"))},success:function(a){d(!1);return a.length?t(a):growl.warn(tr("Internet error"))}})};z=function(){d(!0);return rest.forum.list("post",{data:{topic:TOPIC_ID,sort:"updateTime",asc:!1,first:k.length,limit:20},error:function(){d(!1);return growl.warn(tr("Internet error"))},success:function(a){d(!1);return a.length?t(a):growl(tr("No more"))}})};
w=function(){return $(".topic > .footer > .btn-more").click(function(){var a;a=$(this);a.data("locked")||(a.data("lock",!0),z(),a.data("lock",!1));return!1})};this.READY=!1;this.addPost=function(a){var b;k.push(a);document.title=""+s+" ("+k.length+")";return"post"===a.type?(a=n(a),$(a).prependTo(".topic > .posts"),r(),p()):"reply"===a.type?(b=q(a.replyId),b.length?(a=n(a),$(a).appendTo(b.children(".reply")),r(),p()):l("addPost: error: post lost")):l("addPost: error: unknown post type")};this.updatePost=
function(a){var b;if(b=u(a.id))if(util.fillObject(b,a),b=q(a.id),b.length){a=$(n(a));a.children(".reply").replaceWith(b.children(".reply"));b.replaceWith(a);r();p();return}return l("updatePost: error: post lost")};v=function(){if(null==this.i18nBean)return l("init: wait"),setTimeout(v,100);l("init: enter");moment.locale("ja");x();w();A();this.READY=!0;return l("init: leave")};$(function(){return v()})}).call(this);
