...
h=function(){var a,b;b=this.postView.search;a=$("ul.filter > li.active");b.sort=a.data("sort-key");b.asc=a.data("sort-asc");return this.postView.refresh()};e=function(){$(".new-post").click(function(){g(TOPIC_ID);return!1});return $("ul.filter > li > a").click(function(){var a;a=$(this).parent("li");if(a.hasClass("active"))return!1;a.parent("ul").children("li.active").removeClass("active");a.addClass("active");h();return!1})};d=function(){if(null==this.i18nBean)return c("init: wait"),setTimeout(d,
100);c("init: enter");moment.locale(LOCALE);topicjs.init();postsjs.init();f();e();this.READY=!0;return c("init: leave")};$(function(){return d()})}).call(this);
