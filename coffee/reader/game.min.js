(function(){var k,l,c,h,m,n,p,q,r,f=function(b,a){return function(){return b.apply(a,arguments)}};c=function(){};k=Haml('%a(href="#{url}",title="#{url}")\n  %img.img-rounded(src="#{url}")');r=function(b){return k({url:b})};q=function(){return gameBean.sampleImages.split(",").map(r).join("")};this.bindAmazon=function(){var b;c("bindAmazon: enter");b=$("iframe.amazon");b.load(function(){var a,b;b=$(this);a=b.contents().find("body");return a.html()?(a.css("background-color","transparent").find(".crIFrame").css("margin-left",
...
d.hide(),g="100%",a=zoomer.youtubeFrameHeight()+30,e.addClass("iframe").width(g).height(a),d=e.data("id"),a=b(d),e.append(a));return!1}));return c("bindYoutube: leave")};l=function(){function b(a){this.viewBean=a;this.youtubeFrameHeight=f(this.youtubeFrameHeight,this);this.youtubeFrameWidth=f(this.youtubeFrameWidth,this);this.zoomYoutube=f(this.zoomYoutube,this);this.youtubeWidth=f(this.youtubeWidth,this);this.zoom=f(this.zoom,this);this.bind=f(this.bind,this);this.maxWidth=f(this.maxWidth,this);
this.ratio=1;this.bind()}b.prototype.maxWidth=function(){return Math.max(0,this.viewBean.width()-90)};b.prototype.bind=function(){return $(window).resize(function(a){return function(){return a.zoomYoutube(a.ratio)}}(this))};b.prototype.zoom=function(a){var b;this.ratio=a;$("img.zoom.zoom-cover").width(230*a);b=$("section.cg .images");b.length&&(b.children("img").width(220*a),b.masonry());return this.zoomYoutube(a)};b.prototype.youtubeWidth=function(a){return Math.min(220*(null!=a?a:this.ratio),this.maxWidth())};
b.prototype.zoomYoutube=function(a){return $(".youtube:not(.iframe)").width(this.youtubeWidth(a))};b.prototype.youtubeFrameWidth=function(){return Math.min(480*this.ratio,Math.max(480,this.maxWidth()))};b.prototype.youtubeFrameHeight=function(){return 9*this.youtubeFrameWidth()/16};return b}();p=function(){var b;c("bindToolbar: enter");this.zoomer=new l(this.viewBean);b=new ZoomSlider(function(a){return function(b){return a.zoomer.zoom(1+2*b)}}(this));new Toolbar(this.viewBean,{width:60,height:244,
move:b.reloadOffset});return c("bindToolbar: leave")};n=function(){c("bindRuby: enter");$.fn.inject=function(){return this.each(function(){return window.injectruby(this)})};$(".ruby").inject();return c("bindRuby: leave")};m=function(){var b;b=$("section.cg");return b.find("input.switch").bootstrapSwitch().on("switchChange.bootstrapSwitch",function(a,c){var d;d=b.find(".images");return c?$container.hasClass("loaded")?d.fadeIn():d.hide().html(q()).addClass("loaded").imagesLoaded(function(){return d.fadeIn().masonry({itemSelector:"img"})}):
d.fadeOut()})};h=function(){if(null==this.gameBean)return c("init: wait"),setTimeout(h,100);c("init: enter");p();m();n();return c("init: leave")};$(function(){return h()})}).call(this);
