...
more:a.find("> .sec-content > .footer > .btn-more"),topicId:TOPIC_ID})};g=function(){var a;$(".sec-btn").click(function(){var b,a;a=$(this);b=a.parent(".sec");b.length&&(b=b.find(".sec-content"),b.is(":empty")&&a.hasClass("checked")||(a.toggleClass("checked"),b.is(":empty")||b.toggle("fade")));return!1});a=$(".sec.sec-topics");a.find(".new-topic").click(function(){var a,c;SUBJECT_ID?(a=SUBJECT_ID,c="game"):(a=101,c="subject");f("chat",a,c);return!1});a=$(".sec.sec-reviews");a.find(".new-topic").click(function(){var a,
