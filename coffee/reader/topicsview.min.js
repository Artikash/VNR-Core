...
h(a);return!1})};e=function(){if(null==this.i18nBean)return d("init: wait"),setTimeout(e,100);d("init: enter");moment.locale("ja");topicsjs.init();postsjs.init();g();f();this.READY=!0;return d("init: leave")};$(function(){return e()})}).call(this);
