...
$more:a.find("> .sec-content > .footer > .btn-more"),search:b,complete:!TOPIC_ID});this.reviewView.show();this.topicView.show();a=$(".sec-posts");if(TOPIC_ID)return this.postView=new postsjs.PostList({$container:a.find("> .sec-content > .forum-posts"),$more:a.find("> .sec-content > .footer > .btn-more"),topicId:TOPIC_ID,search:{sort:"updateTime",asc:!1}}),this.postView.show()};g=function(){var a;$(".sec-btn").click(function(){var a,b;b=$(this);a=b.parent(".sec");a.length&&(a=a.find(".sec-content"),
a.is(":empty")&&b.hasClass("checked")||(b.toggleClass("checked"),a.is(":empty")||a.toggle("fade")));return!1});a=$(".sec.sec-topics");a.find(".new-topic").click(function(){var a,b;SUBJECT_ID?(a=SUBJECT_ID,b="game"):(a=101,b="subject");f("chat",a,b);return!1});a=$(".sec.sec-reviews");a.find(".new-topic").hide().click(function(){var a;SUBJECT_ID&&((a=reviewView.findUserReview())?k(a):f("review",SUBJECT_ID,"game"));return!1});a=$(".sec.sec-posts");return a.find(".new-post").click(function(){l(TOPIC_ID);
