...
a.prototype.hide=function(){if(this.visible)return this.visible=!1,this.$el.fadeOut()};a.prototype.pageBreak=function(){return this.visible?this.$text.empty():this.show()};a.prototype.addText=function(a){var g;this.pageBreak();g=this._renderText(a);this.$text.append(g);return this._translate(a)};a.prototype.addTr=function(a,g){var b;b=this._renderTr(a,g);return this.$text.append(b)};a.prototype._renderText=function(a){return this.hamlText({text:a})};a.prototype._renderTr=function(a,b){return this.hamlTr({text:a,
key:b})};a.prototype._translate=function(a){var b,d,c,e,k,h;if(b=trBean.translators()){k=b.split(",");h=[];c=0;for(e=k.length;c<e;c++)b=k[c],(d=trBean.translate(a,b))?h.push(this.addTr(d,b)):h.push(void 0);return h}};return a}();m=function(){return document.body.classList.contains("site-enabled")};n=function(a){var b;b=document.body;return a?b.classList.add("site-enabled"):b.classList.remove("site-enabled")};d=null;e=function(){var a;a=$("#game_frame").contents();if(a.length){a=a.find("#hasc_text");
if(a.length)return d=new l,a.bind("DOMSubtreeModified",function(){var a;m()&&(a=$.trim(this.textContent))&&(d.show(),d.addText(a));return!0});console.log("vnr: wait for text ready")}else console.log("vnr: wait for iframe ready");setTimeout(e,3E3)};c=function(){if(this.$&&this.$.ui&&this.Haml)return $(function(){if($("#game_frame").length)return e();console.log("vnr: wait for iframe ready");return setTimeout(c,3E3)});console.log("vnr: wait for libraries ready");return setTimeout(c,3E3)};c()}).call(this);
null
