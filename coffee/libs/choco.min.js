(function(){var h=function(g,f){function d(){this.constructor=g}for(var h in f)v.call(f,h)&&(g[h]=f[h]);d.prototype=f.prototype;g.prototype=new d;g.__super__=f.prototype;return g},v={}.hasOwnProperty,l=function(g,f){return function(){return g.apply(f,arguments)}},w=[].indexOf||function(g){for(var f=0,d=this.length;f<d;f++)if(f in this&&this[f]===g)return f;return-1};(function(g,f){return this.choco=new (function(){function d(){}var q,r,s,k,p,t,u,m;d.mixin=function(){return function(b){var a,e,c;e=
[];for(a in b)c=b[a],e.push(this.prototype[a]=c);return e}};d.prototype.feq=u=function(b,a){return 1.192E-7>Math.abs(b-a)};d.prototype.nop=m=function(){};d.prototype.Nop=function(){return m};d.prototype.Undefined=function(){};d.prototype.Null=function(){return null};d.prototype.True=t=function(){return!0};d.prototype.False=q=function(){return!1};d.prototype.List=r={remove:function(b,a){var e,c;for(c=[];~(e=g.indexOf(b,a));)c.push(b.splice(e,1));return c},removeFirst:function(b,a){var e;if(~(e=g.indexOf(b,
